			...
			<td>
				<table width="100%" border="0" align="center" cellpadding="4"
					...
					<tr align="left" bgcolor="#F2FDFF">
						<td height="30" colspan="17" background="images/table_header.gif">购物车列表</td>
					</tr>
				</table>
			</td>
		</tr>
					...
					<tr align="right" bgcolor="#ebf0f7">
						<td colspan="21">
							<table width="100%" border="0" align="center" cellpadding="4"
								...
								<tr align="left">
									<td colspan="17">
										<form action="gouwucheList.do" name="myform" method="post">
											查询 编号：<input name="bianhao" type="text" id="bianhao"
												...
												class="form-control2" /> 下单人：<input name="xiadanren"
												type="text" id="xiadanren" class="form-control2" /> <input
				...
				%>
									<tr align="center" bgcolor="#FFFFFF">
										...
										<td align="center"><a class="btn btn-info btn-small"
											href='yifusonghui_add.jsp?id=${u.id}'>衣服送回</a> <a
											class="btn btn-info btn-small"
											href="doUpdateGouwuche.do?id=${u.id }">编辑</a> <a
											class="btn btn-info btn-small"
											href="deleteGouwuche.do?id=${u.id }"
											onclick="{if(confirm('确定要删除吗?')){return true;}return false;}">删除</a>
											<a class="btn btn-info btn-small"
											href="gouwucheDetail.do?id=${u.id}">详细</a></td>
									</tr>
								</c:forEach>
							</table></td>
					</tr>
	...
	<p align="center" class="fy">
		<c:if test="${sessionScope.p==1 }">
			<c:if test="${page.page>1}">
				<a href="gouwucheList.do?page=1">首页</a>
				<a href="gouwucheList.do?page=${page.page-1 }"> 上一页</a>
			</c:if>
			<c:if test="${page.page<page.totalPage}">
				<a href="gouwucheList.do?page=${page.page+1 }">下一页</a>
				<a href="gouwucheList.do?page=${page.totalPage }">末页</a>
			</c:if>
		</c:if>
	</p>
