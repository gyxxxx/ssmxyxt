			...
			<td bgcolor="#FFFFFF">
								...
								<tr align="left">
									<td colspan="17">
										<form action="shoucangjiluList.do" name="myform" method="post">
											查询 username：<input name="username" type="text" id="username"
												style='border: solid 1px #000000; color: #666666' size="12" />
											xwid：<input name="xwid" type="text" id="xwid"
												style='border: solid 1px #000000; color: #666666' size="12" />
				...
				%>
									<tr align="center" bgcolor="#FFFFFF">
										...
										<td align="center"><a
											href="doUpdateShoucangjilu.do?id=${u.id }">编辑</a> <a
											href="deleteShoucangjilu.do?id=${u.id }"
	...
	<p align="center">
		<c:if test="${sessionScope.p==1 }">
			<c:if test="${page.page>1}">
				...
				<a href="shoucangjiluList.do?page=${page.page-1 }"> 上一页</a>
			</c:if>
			<c:if test="${page.page<page.totalPage}">
				<a href="shoucangjiluList.do?page=${page.page+1 }">下一页</a>
				<a href="shoucangjiluList.do?page=${page.totalPage }">末页</a>
			</c:if>
		</c:if>
	</p>
