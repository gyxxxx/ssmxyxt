...
<body>
	<form action="updateShoucangjilu.do" name="form1" method="post">
		<table width="100%" border="1" align="center" cellpadding="3"
			...
			<tr bgcolor="#E7E7E7">
				<td height="20" colspan="2" background="images/table_header.gif">修改收藏记录<input
					type="hidden" name="id" value="${shoucangjilu.id}" /></td>
			</tr>
			<tr>
				...
				<td><input name='username' type='text' id='username'
					...
					value='${sessionScope.userxinxi.username}' readonly="readonly" />&nbsp;*<label
					id='clabelusername' /></td>
			</tr>
			<tr>
				<td width="200">xwid：</td>
				<td><input name='xwid' type='text' id='xwid' value=''
					onblur='checkform()'
			...
			<tr>
				<td width="200">字段：</td>
				<td><input name='ziduan' type='text' id='ziduan' value=''
