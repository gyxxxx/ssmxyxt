									...
									<td colspan="17">
										<form action="allusersList.do" name="myform" method="post">
											查询 用户名：<input name="username" type="text" id="username"
												...
												name="Submit" value="添加" class="btn btn-info btn-small"
												onclick="javascript:location.href='allusers_add.jsp';" />
										</form>
									</td>
								</tr>
							</table>
				...
				%>
									<tr align="center" bgcolor="#FFFFFF">
										...
										<td height="45" align="center"><a
											...
											href="doUpdateAllusers.do?id=${u.id }">编辑</a> | <a
											class="btn btn-info btn-small"
	...
	<p align="center" class="fy">
		<c:if test="${sessionScope.p==1 }">
			<c:if test="${page.page>1}">
				...
				<a href="allusersList.do?page=${page.page-1 }"> 上一页</a>
			</c:if>
			<c:if test="${page.page<page.totalPage}">
				<a href="allusersList.do?page=${page.page+1 }">下一页</a>
				<a href="allusersList.do?page=${page.totalPage }">末页</a>
			</c:if>
		</c:if>
	</p>
