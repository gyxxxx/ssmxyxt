...
<body>
	<form action="updateXiyixinxi.do" name="form1" method="post">
		<table width="100%" border="1" align="center" cellpadding="3"
			cellspacing="1" style="border-collapse: collapse" bgcolor="#F2FDFF">
			<tr bgcolor="#E7E7E7">
				<td height="30" colspan="2" background="images/table_header.gif">修改洗衣信息<input
					type="hidden" name="id" value="${xiyixinxi.id}" /></td>
			</tr>
			<tr>
				<td width="200">编号：</td>
			...
			<script language="javascript">document.form1.bianhao.value='${xiyixinxi.bianhao}';</script>
			<script language="javascript">document.form1.xiyifangfa.value='${xiyixinxi.xiyifangfa}';</script>
			<script language="javascript">document.form1.yifuleixing.value='${xiyixinxi.yifuleixing}';</script>
			<script language="javascript">document.form1.zhuyineirong.value='${xiyixinxi.zhuyineirong}';</script>
			<script language="javascript">document.form1.jiage.value='${xiyixinxi.jiage}';</script>
			<script language="javascript">document.form1.beizhu.value='${xiyixinxi.beizhu}';</script>
