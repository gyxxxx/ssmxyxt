		...
		<table width="100%" border="1" align="center" cellpadding="3"
			...
			<tr>
				...
				<td><input name='username' type='text' id='username' value=''
					onblur='hsgcheck()' class="form-control" />&nbsp;*<label
					id='clabelusername' style="margin-top: 16px;" /></td>
			</tr>
			<tr>
				<td width="200">密码：</td>
				<td><input name='pwd' type='text' id='pwd' value=''
					onblur='checkform()' class="form-control" />&nbsp;*<label
					id='clabelpwd' style="margin-top: 16px;" /></td>
			</tr>
			<tr>
				<td width="200">权限：</td>
