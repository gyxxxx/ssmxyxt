...
<BODY text=#000000 bgColor=#ffffff leftMargin=0 topMargin=4>
	<CENTER>
		...
		<FORM name=alipayment onSubmit="return CheckForm();"
			action=alipayto.asp method=post target="_blank">
			<table>
				<tr>
					<td>
						<TABLE cellSpacing=0 cellPadding=0 width=740 border=0>
							...
							<TR style="display: none">
								...
								<TD class=form-right><INPUT size=30 name=aliorder
									maxlength="200" value=""><span>如：7月5日定货款。</span></TD>
							</TR>
							<TR style="display: none">
								...
								<TD class=form-right><INPUT maxLength=10 size=30
									...
									readonly="readonly" /> <span>如：112.21</span></TD>
							</TR>
							<TR style="display: none">
								<TD class=form-left>备注：</TD>
								<TD class=form-star></TD>
								<TD class=form-right><TEXTAREA name=alibody rows=5 cols=40
										wrap="physical"></TEXTAREA><BR> （如联系方法，图书要求、数量等。100汉字内）</TD>
							</TR>
							<TR>
								...
								<TD class=form-right>
									<table>
										<tr>
											<td><input type="radio" name="pay_bank"
												value="directPay" checked><img
										...
										<tr>
											...
											<td><input type="radio" name="pay_bank"
												value="PSBC-DEBIT" /><img src="images/PSBC_OUT.gif"
												border="0" /></td>
										</tr>
									</table>
								</TD>
							...
							<TR>
								...
								<TD class=form-right><img src="images/button_sure.gif"
									onClick="javascript:location.href='../zhifu.jsp?id=<%=request.getParameter("id")%>&biao=<%=request.getParameter("biao")%>';"></TD>
							</TR>
						</TABLE>
					</td>
		...
		<TABLE cellSpacing=0 cellPadding=0 width=760 align=center border=0>
			...
			<TR align=middle>
				<TD class="txt12 lh15"><IMG alt="支付宝通过“国际权威安全认证” "
					src="images/logo_vbvv.gif" border=0><BR>支付宝通过“国际权威安全 认证”
				</TD>
			</TR>
		</TABLE>
</BODY>
