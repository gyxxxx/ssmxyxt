		...
		<table width="100%" border="1" align="center" cellpadding="3"
			...
			<tr>
				...
				<td><textarea name="neirong" cols="100" rows="8"
						style="width: 700px; height: 200px; visibility: hidden;"><%=ncontent%></textarea></td>
			</tr>


			<tr align='center' height="22">
				<td width="116" height="45" align="right">&nbsp;</td>
				<td width="1327" height="45" align="left"><input type="submit"
					name="querenzhuce" id="querenzhuce" value="提交"
					class="btn btn-info btn-small" /> <input type="reset" value="重置"
