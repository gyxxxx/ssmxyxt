								...
								<tr align="left">
									<td colspan="17">
										<form action="guizixinxiList.do" name="myform" method="post">
											��ѯ �����ţ�<input name="huoguibianhao" type="text"
												id="huoguibianhao" class="form-control2" /> ���<input
					...
					<tr align="center">
						<td style="padding-left: 0px; padding-right: 0px;"><table
								...
								<tr>
									...
									<td align='center' bgcolor='#ebf0f7'>���</td>
									<td align='center' bgcolor='#ebf0f7'>λ��</td>
				...
				%>
									<tr align="center" bgcolor="#FFFFFF">
										...
										<td align="center">
											...
											href="guizixinxiDetail.do?id=${u.id}">��ϸ</a>
										</td>
									</tr>
								</c:forEach>
							</table></td>
	...
	<p align="center" class="fy">
		<c:if test="${sessionScope.p==1 }">
			<c:if test="${page.page>1}">
				<a href="guizixinxiList.do?page=1">��ҳ</a>
				<a href="guizixinxiList.do?page=${page.page-1 }"> ��һҳ</a>
			</c:if>
			<c:if test="${page.page<page.totalPage}">
				<a href="guizixinxiList.do?page=${page.page+1 }">��һҳ</a>
				<a href="guizixinxiList.do?page=${page.totalPage }">ĩҳ</a>
			</c:if>
		</c:if>
	</p>
