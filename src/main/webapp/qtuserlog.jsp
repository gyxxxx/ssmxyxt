...
<form action="hsgloginyanzheng.jsp" method="post" name="userlog"
	id="userlog" style="display: inline">
		...
		<div class="modal-dialog modal-sm" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="input-group mb">
						<span class="input-group-addon" id="basic-addon1">权限</span> <select
							name='cx' id='cx' class="form-control">
					...
					<div class="input-group mb">
						<span class="input-group-addon" id="basic-addon1">验证码</span> <input
							type="text" class="form-control" id="pagerandom"
							name="pagerandom" placeholder="验证码">
						<%
				...
				<div class="modal-footer">
					...
					<button type="submit" class="btn btn-primary"
						onclick="return checklog();">确定</button>
				</div>
			</div>
		</div>
	</div>
