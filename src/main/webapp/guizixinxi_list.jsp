			...
			<td>
				<table width="100%" border="0" align="center" cellpadding="4"
					...
					<tr align="left" bgcolor="#F2FDFF">
						<td height="30" colspan="17" background="images/table_header.gif">柜子信息列表</td>
					</tr>
				</table>
			</td>
		</tr>
					...
					<tr align="right" bgcolor="#ebf0f7">
						<td colspan="21">
							<table width="100%" border="0" align="center" cellpadding="4"
								...
								<tr align="left">
									<td colspan="17">
										<form action="guizixinxiList.do" name="myform" method="post">
											查询 货柜编号：<input name="huoguibianhao" type="text"
												id="huoguibianhao" class="form-control2" /> 规格：<input
												name="guige" type="text" id="guige" class="form-control2" />
				...
				%>
									<tr align="center" bgcolor="#FFFFFF">
										...
										<td align="center"><a class="btn btn-info btn-small"
											href="doUpdateGuizixinxi.do?id=${u.id }">编辑</a> <a
											class="btn btn-info btn-small"
											href="deleteGuizixinxi.do?id=${u.id }"
											onclick="{if(confirm('确定要删除吗?')){return true;}return false;}">删除</a>
											<a class="btn btn-info btn-small"
											href="guizixinxiDetail.do?id=${u.id}">详细</a></td>
									</tr>
								</c:forEach>
							</table></td>
					</tr>
	...
	<p align="center" class="fy">
		<c:if test="${sessionScope.p==1 }">
			<c:if test="${page.page>1}">
				<a href="guizixinxiList.do?page=1">首页</a>
				<a href="guizixinxiList.do?page=${page.page-1 }"> 上一页</a>
			</c:if>
			<c:if test="${page.page<page.totalPage}">
				<a href="guizixinxiList.do?page=${page.page+1 }">下一页</a>
				<a href="guizixinxiList.do?page=${page.totalPage }">末页</a>
			</c:if>
		</c:if>
	</p>
