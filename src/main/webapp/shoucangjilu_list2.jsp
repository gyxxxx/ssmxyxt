	...
	i++;
     %>
					<tr align='center' bgcolor="#FFFFFF"
						onMouseOver="this.style.backgroundColor='#EDDCC2'"
						onMouseOut="this.style.backgroundColor='#ffffff'" height="22">
						<td width="50" height="45"><%=i %></td>
						<td height="45">[<%=RS_result.getString("biao")%>]
						</td>
		...
		%>
						...
						<td width="150" height="45" align="center"><a
							class="btn btn-info btn-small"
							href="deleteShoucangjilu.do?id=<%=RS_result.getString("id")%>"
							onclick="return confirm('真的要删除？')">删除</a> <a
							class="btn btn-info btn-small"
							href="<%=RS_result.getString("biaoj")%>Detail.do?id=<%=RS_result.getString("xwid")%>"
