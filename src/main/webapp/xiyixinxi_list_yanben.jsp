			...
			<td>
				<table width="100%" border="0" align="center" cellpadding="4"
					...
					<tr align="left" bgcolor="#F2FDFF">
						<td colspan="17" background="images/table_header.gif">ϴ����Ϣ�б�</td>
					</tr>
				</table>
			</td>
		</tr>
									...
									<td colspan="17">
										<form action="xiyixinxiList.do" name="myform" method="post">
											��ѯ ��ţ�<input name="bianhao" type="text" id="bianhao"
												class="form-control2" /> ϴ�·�����<select name='xiyifangfa'
												id='xiyifangfa' class="form-control2"><option
													value="">����</option>
												<option value="��ϴ">��ϴ</option>
												<option value="����ϴ">����ϴ</option>
												<option value="ˮϴ">ˮϴ</option></select> �·����ͣ�<select
												...
												<option value="�����޷�">�����޷�</option>
												<option value="�����޷�">�����޷�</option>
												<option value="����">����</option></select> <input type="submit"
												value="��ѯ" class="btn btn-info btn-small" />
										</form>
									</td>
								</tr>
							</table>
				...
				%>
									<tr align="center" bgcolor="#FFFFFF">
										...
										<td align="center">
											...
											href="xyxxDetail.do?id=${u.id}" target="_blank">��ϸ</a>
										</td>
									</tr>
								</c:forEach>
							</table></td>
	...
	<p align="center" class="fy">
		<c:if test="${sessionScope.p==1 }">
			<c:if test="${page.page>1}">
				<a href="xiyixinxiList.do?page=1">��ҳ</a>
				<a href="xiyixinxiList.do?page=${page.page-1 }"> ��һҳ</a>
			</c:if>
			<c:if test="${page.page<page.totalPage}">
				<a href="xiyixinxiList.do?page=${page.page+1 }">��һҳ</a>
				<a href="xiyixinxiList.do?page=${page.totalPage }">ĩҳ</a>
			</c:if>
		</c:if>
	</p>
