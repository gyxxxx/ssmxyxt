...
<body>
	<form action="addXinwentongzhi.do" name="form1" method="post">
		<table width="100%" border="1" align="center" cellpadding="3"
			...
			<tr>
				<td width="200">标题：</td>
				<td><input name='biaoti' type='text' id='biaoti'
					placeholder="请输入标题" value='' onblur='checkform()'
					class="form-control" style="width: 600px;" />&nbsp;*<label
					id='clabelbiaoti' style="margin-top: 16px;" /></td>
			</tr>
			<tr>
				<td width="200">类别：</td>
				<td><input name='leibie' type='text' id='leibie'
					value='<%=lb%>' onblur='checkform()' class="form-control" />&nbsp;*<label
					id='clabelleibie' /></td>
			</tr>
			<tr>
				<td width="200">内容：</td>
