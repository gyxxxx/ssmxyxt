...
<script src="images/verificationNumbers.js"
	tppabs="images/verificationNumbers.js"></script>
...
<body>
	<dl class="admin_login">
		<dt>
			...
			<strong><font color=white>智能洗衣系统</font></strong> <em>Management
				System</em>
		</dt>
		<form name="f11" id="f11" method="post" action="hsgloginyanzheng.jsp">
			...
			<dd class="val_icon">
				...
				&nbsp; <font
					style="cursor: pointer; position: absolute; padding-top: 10px;">
					<%
								String yzm=code.getCheckCode();
								%> <input type="hidden" name="yzm" value="<%=yzm %>"> <font
					color="#FFFFFF"><%=yzm %></font>
				</font>
			</dd>
			<dd>
				<input type="submit" name="Submit" value="登陆"
					onClick="return hsgchecklogin();" class="submit_btn">
