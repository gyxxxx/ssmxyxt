		...
		<div class="leftsidebar_box">
			...
			<dl class="custom">
				<dt onClick="changeImage()">
					个人资料管理<img src="images/left/select_xl01.png">
				</dt>
				<dd>
					<a href="doUpdateYonghuzhuce2.do" target="hsgmain">修改个人资料</a>
				</dd>
			...
			<dl class="custom">
				...
				<dd>
					<a href="gouwucheList2.do" target="hsgmain">购物车查询</a>
				</dd>
			...
			<dl class="custom">
				...
				<dd>
					<a href="yifusonghuiList2.do" target="hsgmain">衣服送回查询</a>
				</dd>
