			...
			<td bgcolor="#FFFFFF">
				...
				%>
									<tr align="center" bgcolor="#FFFFFF">
										...
										<td>${u.jiage}</td>
										<td>${u.xiadanren}</td>
										<td align='center' bgcolor='#ebf0f7'>${u.iszf}<c:if
												test="${u.iszf=='否'}">
												<input type="button" value="支付"
													onclick="zhifu(${u.id},'gouwuche')" />
											</c:if>
										</td>
	...
	<p align="center" class="fy">
		<c:if test="${sessionScope.p==1 }">
			<c:if test="${page.page>1}">
				...
				<a href="gouwucheList2.do?page=${page.page-1 }"> 上一页</a>
			</c:if>
			<c:if test="${page.page<page.totalPage}">
				<a href="gouwucheList2.do?page=${page.page+1 }">下一页</a>
				<a href="gouwucheList2.do?page=${page.totalPage }">末页</a>
			</c:if>
		</c:if>
	</p>
