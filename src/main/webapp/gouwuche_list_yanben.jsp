			...
			<td>
				<table width="100%" border="0" align="center" cellpadding="4"
					...
					<tr align="left" bgcolor="#F2FDFF">
						<td colspan="17" background="images/table_header.gif">���ﳵ�б�</td>
					</tr>
				</table>
			</td>
		</tr>
									...
									<td colspan="17">
										<form action="gouwucheList.do" name="myform" method="post">
											...
											�·����ͣ�<input name="yifuleixing" type="text"
												id="yifuleixing" class="form-control2" /> �µ��ˣ�<input
												name="xiadanren" type="text" id="xiadanren"
				...
				%>
									<tr align="center" bgcolor="#FFFFFF">
										...
										<td align="center">
											...
											href="gouwucheDetail.do?id=${u.id}">��ϸ</a>
										</td>
									</tr>
								</c:forEach>
							</table></td>
	...
	<p align="center" class="fy">
		<c:if test="${sessionScope.p==1 }">
			<c:if test="${page.page>1}">
				<a href="gouwucheList.do?page=1">��ҳ</a>
				<a href="gouwucheList.do?page=${page.page-1 }"> ��һҳ</a>
			</c:if>
			<c:if test="${page.page<page.totalPage}">
				<a href="gouwucheList.do?page=${page.page+1 }">��һҳ</a>
				<a href="gouwucheList.do?page=${page.totalPage }">ĩҳ</a>
			</c:if>
		</c:if>
	</p>
