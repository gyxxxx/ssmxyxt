...
<body>
	<form action="" name="form1" method="post">
		<table width="32%" height="126" border="1" align="center"
			...
			<tr>
				<td>新密码：</td>
				<td><input name="xmm1" type="password" id="xmm1"
					class="form-control" /></td>
			</tr>
			<tr>
				<td>确认密码：</td>
				<td><input name="xmm2" type="password" id="xmm2"
					class="form-control" /></td>
			</tr>
			<tr>
				<td height="45" colspan="2" align="center"><input name="updt"
					type="hidden" id="updt" value="1"> <input name="Submit"
					type="submit" onClick="return check()" value="确定"
					class="btn btn-info btn-small" /> <input name="Submit2"
