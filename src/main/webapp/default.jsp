					...
					<div class="panel panel-primary mt">
						<div class="panel-heading">
							...
							<div style="display: flex">
								...
								<h4 class="panel-title">购物需知</h4>
							</div>
						</div>
						<div class="panel-body">
							<div class="panel-body-left">
								<c:forEach items="${syxinwentongzhi1 }" var="a">
									<a href="xwtzDetail.do?id=${a.id}"><i
										class="wjs_icon wjs_icon_news_02"></i>
										${fn:substring(a.biaoti, 0, 30)}<span>${fn:substring(a.addtime, 0, 10)}</span></a>
								</c:forEach>

							</div>
							<div class="panel-body-right">
								<c:forEach items="${syxinwentongzhi2 }" var="b">
									<a href="xwtzDetail.do?id=${b.id}"><i
										class="wjs_icon wjs_icon_news_02"></i>
										${fn:substring(b.biaoti, 0, 30)}<span>${fn:substring(b.addtime, 0, 10)}</span></a>
								</c:forEach>
							</div>
						</div>
					</div>
			...
			<div class='row'>
				<c:forEach items="${syyonghuzhuce1}" var="b">
					<div class='col-xs-12 col-sm-6 col-md-4 col-lg-3 works'>
						<a href="yhzcDetail.do?id=${b.id}"><div class='bg'>${b.xingming}</div>
							<div class='tab-content item' data-brief=''>
								<img src="${b.touxiang}" alt=''>
							</div></a>
					</div>
				</c:forEach>
			</div>
		...
		<div class="container">
			...
			<div class="col-md-5 imgs">
				<ul class="nav nav-tabs">
					<li class="col-md-6"><img src="qtimages/slide_01_640x340.jpg"
						class="col-md-12"></li>
					<li class="col-md-6"><img src="qtimages/slide_02_640x340.jpg"
						class="col-md-12"></li>
					<li class="col-md-6"><img src="qtimages/slide_03_640x340.jpg"
						class="col-md-12"></li>
					<li class="col-md-6"><img src="qtimages/slide_04_640x340.jpg"
						class="col-md-12"></li>
				</ul>
			</div>
			<div class="col-md-7">
