			...
			<td>
				<table width="100%" border="0" align="center" cellpadding="4"
					...
					<tr align="left" bgcolor="#F2FDFF">
						<td height="30" colspan="17" background="images/table_header.gif">衣服送回列表</td>
					</tr>
				</table>
			</td>
		</tr>
	...
	<p align="center" class="fy">
		<c:if test="${sessionScope.p==1 }">
			<c:if test="${page.page>1}">
				<a href="yifusonghuiList.do?page=1">首页</a>
				<a href="yifusonghuiList.do?page=${page.page-1 }"> 上一页</a>
			</c:if>
			<c:if test="${page.page<page.totalPage}">
				<a href="yifusonghuiList.do?page=${page.page+1 }">下一页</a>
				<a href="yifusonghuiList.do?page=${page.totalPage }">末页</a>
			</c:if>
		</c:if>
	</p>
