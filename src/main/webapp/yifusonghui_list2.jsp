			...
			<td>
				<table width="100%" border="0" align="center" cellpadding="4"
					...
					<tr align="left" bgcolor="#F2FDFF">
						<td colspan="17" background="images/table_header.gif">衣服送回列表</td>
					</tr>
				</table>
			</td>
		</tr>
					...
					<tr align="right" bgcolor="#ebf0f7">
						<td colspan="21">
							<table width="100%" border="0" align="center" cellpadding="4"
								...
								<tr align="left">
									<td colspan="17">
										<form action="yifusonghuiList2.do" name="myform" method="post">
											查询 编号：<input name="bianhao" type="text" id="bianhao"
												class="form-control2" /> 洗衣方法：<input name="xiyifangfa"
												type="text" id="xiyifangfa" class="form-control2" /> 衣服类型：<input
												name="yifuleixing" type="text" id="yifuleixing"
												class="form-control2" /> 货柜编号：<select name='huoguibianhao'
												id='huoguibianhao' class="form-control2"><option
													value="">所有</option><%=connDbBean.hsggetoption("guizixinxi","huoguibianhao")%></select>
				...
				%>
									<tr align="center" bgcolor="#FFFFFF">
										...
										<td height="45" align="center"><a
											...
											href="doUpdateYifusonghui.do?id=${u.id }">编辑</a> <a
											class="btn btn-info btn-small"
											href="deleteYifusonghui.do?id=${u.id }"
											onclick="{if(confirm('确定要删除吗?')){return true;}return false;}">删除</a>
											<a class="btn btn-info btn-small"
											href="yifusonghuiDetail.do?id=${u.id }">详细</a></td>
									</tr>
								</c:forEach>
							</table></td>
					</tr>
	...
	<p align="center" class="fy">
		<c:if test="${sessionScope.p==1 }">
			<c:if test="${page.page>1}">
				<a href="yifusonghuiList2.do?page=1">首页</a>
				<a href="yifusonghuiList2.do?page=${page.page-1 }"> 上一页</a>
			</c:if>
			<c:if test="${page.page<page.totalPage}">
				<a href="yifusonghuiList2.do?page=${page.page+1 }">下一页</a>
				<a href="yifusonghuiList2.do?page=${page.totalPage }">末页</a>
			</c:if>
		</c:if>
	</p>
