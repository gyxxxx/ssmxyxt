	...
	<div class="container">
		<div class="row">
			<div class="col-md-3 hidden-xs topBar-brand">
				<img src="qtimages/code.jpg" class="logo"> <span class="name">智能洗衣系统</span>
			</div>
    ...
    if((String)request.getSession().getAttribute("username")==null || (String)request.getSession().getAttribute("username")==""){
     %>
				<button class="btn btn-primary" data-toggle="modal"
					data-target="#myLoginModal">登录</button>
				<a href="userreg.jsp" class="btn btn-danger">注册</a>
				<%}else{ %>
				<%=request.getSession().getAttribute("username")%>,[<%=request.getSession().getAttribute("cx")%>]&nbsp;
				<a href="logout.jsp" onclick="return confirm('确定要退出？')"
					class="btn btn-primary">退出</a>&nbsp; <a href="main.jsp"
					class="btn btn-danger">后台</a>
				<%} %>
	...
	<div class="container">
		...
		<div class="collapse navbar-collapse"
			...
			<ul class='nav navbar-nav ml'>
				...
				<li><a href='zzxy.do'>自助洗衣</a></li>
				<li><a href='xyxxList.do'>洗衣信息</a></li>
				<li><a href='userreg.jsp'>会员注册</a></li>

				<li class='show'><a>新闻信息</a>
					<div class='pa'>
						<a href='xwtzList.do?lb=站内新闻'>站内新闻</a> <a
							href='xwtzList.do?lb=购物需知'>购物需知</a>
					</div></li>
				<li class='show'><a>系统概要</a>
					<div class='pa'>
						<a href='dx_detail.jsp?lb=系统简介'>系统简介</a> <a
							href='dx_detail.jsp?lb=关于我们'>关于我们</a> <a
							href='dx_detail.jsp?lb=联系方式'>联系方式</a>
					</div></li>
