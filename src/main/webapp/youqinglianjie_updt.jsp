		...
		<table width="100%" border="1" align="center" cellpadding="3"
			...
			<tr bgcolor="#E7E7E7">
				<td height="30" colspan="2" background="images/table_header.gif">修改友情连接
					<input type="hidden" name="id" value="${youqinglianjie.id}" />
				</td>
			</tr>
			<tr>
				<td width="200">网站名称：</td>
				<td><input name='wangzhanmingcheng' type='text'
					id='wangzhanmingcheng' value='' onblur='checkform()'
					class="form-control" />&nbsp;*<label id='clabelwangzhanmingcheng' /></td>
			</tr>
			<tr>
				<td width="200">网址：</td>
				<td><input name='wangzhi' type='text' id='wangzhi' value=''
					onblur='checkform()' class="form-control" />&nbsp;*<label
					id='clabelwangzhi' /></td>
			</tr>
			<tr>
				<td width="200">logo：</td>
				<td><input name='LOGO' type='text' id='LOGO' size='50' value=''
					onblur='' class="form-control" />
				<div style="margin-top: 16px;">
						&nbsp;<input type='button' value='上传' onClick="up('LOGO')" />
					</div></td>
			</tr>
