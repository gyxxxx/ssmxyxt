...
<body>
	<form action="updateXinwentongzhi.do" name="form1" method="post">
		<table width="100%" border="1" align="center" cellpadding="3"
			...
			<tr bgcolor="#E7E7E7">
				<td height="20" colspan="2" background="images/table_header.gif">修改新闻通知<input
					type="hidden" name="id" value="${xinwentongzhi.id}" /></td>
			</tr>
			<tr>
				<td width="200">标题：</td>
				<td><input name='biaoti' type='text' id='biaoti' value=''
					onblur='checkform()' class="form-control" style="width: 600px;" />&nbsp;*<label
					id='clabelbiaoti' /></td>
			</tr>
			<tr>
				<td width="200">类别：</td>
			...
			<tr>
				...
				<td><textarea name="neirong" cols="100" rows="8"
						style="width: 700px; height: 200px; visibility: hidden;">${xinwentongzhi.neirong}</textarea></td>
			</tr>
			<tr>
				<td width="200">首页图片：</td>
				<td><input name='shouyetupian' type='text' id='shouyetupian'
					size='50' value='' onblur='' class="form-control" />
			...
			<tr>
				<td width="200">点击率：</td>
				<td><input name='dianjilv' type='text' id='dianjilv' value=''
			...
			<tr>
				...
				<td><input name='tianjiaren' type='text' id='tianjiaren'
					...
					value='${sessionScope.userxinxi.tianjiaren}' readonly="readonly" /></td>
			</tr>
