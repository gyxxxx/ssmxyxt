			...
			<td bgcolor="#FFFFFF">
					...
					<tr align="right" bgcolor="#ebf0f7">
						<td colspan="21">
							<table width="100%" border="0" align="center" cellpadding="4"
								...
								<tr align="left">
									<td colspan="17">
										<form action="xinwentongzhiList.do" name="myform"
											method="post">
											查询 标题：<input name="biaoti" type="text" id="biaoti"
												class="form-control2" /> 类别：<input name="leibie"
												type="text" id="leibie" class="form-control2" /> <input
						...
						<td style="padding-left: 0px; padding-right: 0px;"><table
								...
								<tr>
									...
									<td width="150px" height="30" align="center" bgcolor="#ebf0f7">
										添加时间</td>
									<td width="220" height="30" align="center" bgcolor="#ebf0f7">
										操作</td>
								</tr>
								<%
					int i=0;
				...
				%>
									<tr align="center" bgcolor="#FFFFFF">
										...
										<td width='90' align='center'><a href='${u.shouyetupian}'
											target='_blank'><img src='${u.shouyetupian}' width=88
										...
										<td width="220" align="center"><a
											...
											href="doUpdateXinwentongzhi.do?id=${u.id }">编辑</a> <a
											class="btn btn-info btn-small"
											href="deleteXinwentongzhi.do?id=${u.id }"
											onclick="{if(confirm('确定要删除吗?')){return true;}return false;}">删除</a>
											<a class="btn btn-info btn-small"
											href="xwtzDetail.do?id=${u.id}" target="_blank">详细</a></td>
									</tr>
								</c:forEach>
							</table></td>
					</tr>
	...
	<p align="center" class="fy">
		<c:if test="${sessionScope.p==1 }">
			<c:if test="${page.page>1}">
				...
				<a href="xinwentongzhiList.do?page=${page.page-1}&lb=<%=lb%>">
					上一页</a>
			</c:if>
			<c:if test="${page.page<page.totalPage}">
				<a href="xinwentongzhiList.do?page=${page.page+1}&lb=<%=lb%>">下一页</a>
				<a href="xinwentongzhiList.do?page=${page.totalPage}&lb=<%=lb%>">末页</a>
			</c:if>
		</c:if>
	</p>
